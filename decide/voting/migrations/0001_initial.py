# Generated by Django 2.0 on 2021-01-14 12:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pregunta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='respuestas', to='voting.Pregunta')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opcionRespuesta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='respuestasPreferencia', to='voting.OpcionRespuesta')),
            ],
        ),
        migrations.CreateModel(
            name='Votacion',
        ...
        migrations.AddField(
            ...
            name='votacionPreferencia',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='preguntasPreferencia', to='voting.VotacionPreferencia'),
        ),
        migrations.AddField(
            model_name='preguntamultiple',
            name='votacionMultiple',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='preguntasMultiples', to='voting.VotacionMultiple'),
        ),
        migrations.AddField(
            model_name='pregunta',
            name='votacion',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='preguntas', to='voting.Votacion'),
        ),
        migrations.AddField(
            model_name='opcionrespuesta',
            name='preguntaPreferencia',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='opcionesRespuesta', to='voting.PreguntaPreferencia'),
        ),
        migrations.AddField(
            model_name='opcionmultiple',
            name='preguntaMultiple',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='opcionesMultiples', to='voting.PreguntaMultiple'),
        ),
    ]
